...
def get_reports():
    # Lấy giá trị năm, tháng, và tuần từ query parameters
    ...
    if selected_week and selected_month:  # Chỉ lọc tuần khi đã chọn tháng
...
def get_chart_data():
    ...
    # Tạo câu truy vấn dựa trên bộ lọc
    query = """
        SELECT year, month, week, game_name, avg_price, max_price, min_price 
        FROM game_sales_report
    """
    conditions = []
    params = []
